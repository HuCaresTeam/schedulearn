...
namespace SchedulearnBackend.Migrations
{
    public partial class AddedTeams : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Team",
                columns: new[] { "Id", "LimitOfConsecutiveLearningDays", "LimitOfLearningDaysPerMonth", "LimitOfLearningDaysPerQuarter", "LimitOfLearningDaysPerYear", "ManagerId" },
                values: new object[,]
                {
                    { 1, 3, 2, 3, 4, 1 },
                    { 2, 2, 1, 3, 3, 2 }
            ...
            migrationBuilder.UpdateData(
                ...
                values: new object[] { "Vadovu", "Vadovas" });
            ...
            migrationBuilder.UpdateData(
                ...
                keyColumn: "Id",
                keyValue: 2,
                columns: new[] { "Name", "Surname", "TeamId" },
                values: new object[] { "Technologiju", "Vadovas", 1 });

            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "JobTitleId", "Name", "Surname", "TeamId" },
                values: new object[,]
                {
                    { 3, 3, "Finansu", "Vadovas", 1 },
                    { 4, 4, "Vardenis", "Pavardenis", 2 },
                    { 5, 4, "Petras", "Petrauskas", 2 },
                    { 6, 5, "Jonas", "Jonauskas", 2 }
                });
            ...
            migrationBuilder.InsertData(
                table: "LearningDays",
                columns: new[] { "Id", "DateFrom", "DateTo", "Description", "TopicId", "UserId" },
                values: new object[] { 7, new DateTime(2020, 4, 26, 10, 30, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 4, 26, 13, 0, 0, 0, DateTimeKind.Unspecified), "Mokausi Capital budgeting", 16, 3 });
            ...
            migrationBuilder.InsertData(
                table: "LearningDays",
                columns: new[] { "Id", "DateFrom", "DateTo", "Description", "TopicId", "UserId" },
                values: new object[] { 8, new DateTime(2020, 4, 26, 14, 30, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 4, 26, 15, 30, 0, 0, DateTimeKind.Unspecified), "Mokausi Sources of capital", 17, 3 });

            migrationBuilder.InsertData(
                table: "LearningDays",
                columns: new[] { "Id", "DateFrom", "DateTo", "Description", "TopicId", "UserId" },
                values: new object[] { 9, new DateTime(2020, 4, 26, 15, 30, 0, 0, DateTimeKind.Unspecified), new DateTime(2020, 4, 26, 17, 0, 0, 0, DateTimeKind.Unspecified), "Mokausi Dividend policy", 18, 3 });
